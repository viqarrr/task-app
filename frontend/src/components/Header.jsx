...
const Header = ({ light, toggleLight, toggleShowSidebar }) => {
  const [isDrop, setIsDrop] = useState(false);
  const handleDrop = () => setIsDrop(!isDrop);
  ...
  return (
    <header className="sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-[48] w-full bg-white border-b text-sm py-2.5 lg:ps-[260px] dark:bg-neutral-800 dark:border-neutral-700">
      <nav className="px-4 sm:px-6 flex basis-full items-center w-full mx-auto">
        <div className="flex items-center gap-4 me-5 lg:me-0 lg:hidden">
        <button
        ...
        <div className="w-full flex items-center justify-end ms-auto md:justify-between gap-x-1 md:gap-x-3">
          ...
          <div className="flex flex-row items-center justify-end gap-1">
            ...
            <div className="hidden md:inline py-2 px-3">
            ...
            <div className="relative inline-flex">
              ...
              <div
                ...
                } transition-[opacity,margin] duration opacity-100  min-w-60 top-10 md:top-12 right-0 bg-white shadow-md rounded-lg mt-2 dark:bg-neutral-800 dark:border dark:border-neutral-700 dark:divide-neutral-700 `}
              >
                <div className="block md:hidden py-3 px-5 bg-gray-100 rounded-t-lg dark:bg-neutral-700">
                  <p className="text-sm text-gray-500 dark:text-neutral-500">
                    Signed in as
                  </p>
                  <p className="text-sm font-medium text-gray-800 dark:text-neutral-200">
                ...
                <div className="p-1.5 space-y-0.5">
                  ...
                  <button
                    onClick={toggleLight}
                    className="flex items-center gap-x-3.5 py-2 px-3 w-full rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700 dark:focus:text-neutral-300"
                  >
                    <svg
                      className="shrink-0 size-4"
                      xmlns="http://www.w3.org/2000/svg"
